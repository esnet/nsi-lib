 ...
 * generated in the net.es.nsi.lib.soap.gen.saml.assertion package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.es.nsi.lib.soap.gen.saml.assertion
     * 
     */
