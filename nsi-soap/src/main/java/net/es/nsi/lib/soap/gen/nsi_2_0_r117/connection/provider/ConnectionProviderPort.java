...
public interface ConnectionProviderPort {
    ...
    @RequestWrapper(localName = "provision", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
    ...
    public net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QuerySummaryConfirmedType querySummarySync(
        ...
        net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryType querySummarySync,
    ...
    ) throws net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.ifce.Error;
    ...
    public net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType queryRecursive(
        @WebParam(partName = "queryRecursive", name = "queryRecursive", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types")
        net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryType queryRecursive,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.nsi.lib.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header
    ) throws net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.ifce.ServiceException;
    ...
    @RequestWrapper(localName = "reserveCommit", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
    @ResponseWrapper(localName = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType")
    ...
    @RequestWrapper(localName = "queryNotification", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryNotificationType")
    @ResponseWrapper(localName = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType")
    ...
    @RequestWrapper(localName = "terminate", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
    @ResponseWrapper(localName = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType")
    ...
    @RequestWrapper(localName = "reserve", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.ReserveType")
    @ResponseWrapper(localName = "reserveResponse", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.ReserveResponseType")
    public void reserve(
        ...
        net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.ReservationRequestCriteriaType criteria,
        @WebParam(name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        net.es.nsi.lib.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType header,
        @WebParam(mode = WebParam.Mode.OUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.nsi.lib.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header1
    ...
    @RequestWrapper(localName = "queryResultSync", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryResultType")
    @ResponseWrapper(localName = "queryResultSyncConfirmed", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryResultConfirmedType")
    @WebResult(name = "result", targetNamespace = "")
    public java.util.List<net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryResultResponseType> queryResultSync(
        @WebParam(name = "connectionId", targetNamespace = "")
        java.lang.String connectionId,
    ...
    @RequestWrapper(localName = "release", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
    @ResponseWrapper(localName = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType")
    public void release(
        @WebParam(name = "connectionId", targetNamespace = "")
        java.lang.String connectionId,
    ...
    @RequestWrapper(localName = "reserveAbort", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericRequestType")
    @ResponseWrapper(localName = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType")
    ...
    @SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType querySummary(
        @WebParam(partName = "querySummary", name = "querySummary", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types")
        net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryType querySummary,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.nsi.lib.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header
    ) throws net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.ifce.ServiceException;
    ...
    @RequestWrapper(localName = "queryResult", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryResultType")
    @ResponseWrapper(localName = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", className = "net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.GenericAcknowledgmentType")
    ...
    public net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryNotificationConfirmedType queryNotificationSync(
        ...
        net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.types.QueryNotificationType queryNotificationSync,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<net.es.nsi.lib.soap.gen.nsi_2_0_r117.framework.headers.CommonHeaderType> header
    ) throws net.es.nsi.lib.soap.gen.nsi_2_0_r117.connection.ifce.Error;
}
